    ...
    <div className="px-4 py-0.5 max-w-screen-2xl mx-auto h-[calc(100vh-120px)]">
      <div className="relative overflow-hidden bg-secondary rounded-2xl h-full flex border border-[#5B5B5B]">
          ...
          <div className="space-y-3">
            ...
            >
              <span className="font-sora">{loading ? 'Signing in...' : 'Sign in'}</span>
            </button>
            ...
            <div className="text-center">
              <button
                ...
                className="text-sm text-primary hover:text-primary/80 font-sora transition-colors disabled:opacity-50"
              >
          ...
          <div>
            ...
            >
              ...
              <span className="font-sora">Sign in with Discord</span>
            </button>
          </div>
