  ...
  return (
    <div className="px-4 py-0.5 max-w-screen-2xl mx-auto h-[calc(100vh-120px)]">
      <div className="relative overflow-hidden bg-secondary rounded-2xl h-full flex items-center justify-center border border-[#5B5B5B]">
        ...
        {/* Dashboard content */}
        <div className="relative z-10 text-center space-y-4 md:space-y-8 max-w-2xl mx-auto px-4 md:px-8 py-4 md:py-0">
          {/* Email verification success banner */}
          {showEmailSuccess && (
            <div className="bg-green-900/20 backdrop-blur border border-green-500/30 rounded-xl p-4 md:p-6 mb-4 md:mb-8 animate-fade-in">
              <div className="flex items-center justify-center mb-3">
                ...
                <h3 className="text-lg md:text-xl font-bold text-green-400 font-sora">
                  {new URLSearchParams(window.location.search).get('type') === 'recovery' 
                    ? 'Password Reset Complete!' 
                    : 'Email Verified Successfully!'}
                </h3>
              </div>
              <p className="text-sm md:text-base text-green-300 font-sora">
                {new URLSearchParams(window.location.search).get('type') === 'recovery'
          ...
          <div>
            <h1 className="text-2xl md:text-4xl lg:text-6xl font-extrabold text-white font-sora mb-4 break-words">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 max-w-4xl mx-auto">
            <div className="bg-black/30 backdrop-blur border border-white/10 rounded-xl p-4 md:p-6 hover:border-primary/30 transition-colors cursor-pointer">
              <h3 className="text-lg md:text-xl font-bold text-white font-sora mb-2">
                Manage Subscription
              </h3>
              <p className="text-sm md:text-base text-gray-400 font-sora">
                View and manage your billing
              </p>
            </div>
            
            <Link to="/dashboard/installation-guide" className="bg-black/30 backdrop-blur border border-white/10 rounded-xl p-4 md:p-6 hover:border-primary/30 transition-colors cursor-pointer block">
              <h3 className="text-lg md:text-xl font-bold text-white font-sora mb-2">
                Installation Guide
              </h3>
              <p className="text-sm md:text-base text-gray-400 font-sora">
